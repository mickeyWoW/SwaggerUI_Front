...
export class TransferEditComponent implements OnInit {
      ...
      this.transferService
        ...
        .subscribe((response) => {
          ...
          this.form.patchValue({
            from_warehouse_id: response.data.from_warehouse_id,
            to_warehouse_id: response.data.to_warehouse_id,
  ...
  onSubmit() {
    ...
    this.transferService
      .editTransfer(
        { ...this.form.value, id: this.transferId },
        this.transferId,
      )
      .subscribe(
        (response) => {
          console.log("transfer", response);
          Swal.fire("Transfer Updated", "", "success");
          this.isLoader = false;
          this.grandTotal = 0;
          this.subTotal = 0;
          this.orderTax = 0;
