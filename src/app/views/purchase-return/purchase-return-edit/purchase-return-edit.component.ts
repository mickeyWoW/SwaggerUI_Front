...
export class PurchaseReturnEditComponent implements OnInit {
  ...
  getParams() {
    ...
    this.purchaseReturnService
      .getPurchaseReturnById(this.purchaseReturnId)
      .subscribe((response) => {
  ...
  onSubmit() {
    ...
    this.purchaseReturnService
      .editPurchaseReturn(
        { ...this.form.value, id: this.purchaseReturnId },
        this.purchaseReturnId,
      )
      .subscribe(
        (response) => {
          console.log("purchase", response);
          Swal.fire("Purchase Updated", "", "success");
          this.isLoader = false;
          this.grandTotal = 0;
          this.subTotal = 0;
          this.orderTax = 0;
