...
@Component({
  selector: "app-sals-edit",
  templateUrl: "./sals-edit.component.html",
  styleUrls: ["./sals-edit.component.scss"],
})
export class SalsEditComponent implements OnInit {
  ...
  getParams() {
    ...
    this.salesService.getSaleById(this.salesId).subscribe((response) => {
  ...
  onSubmit() {
    ...
    this.isLoader = true;
    this.salesService
      .editSales({ ...this.form.value, id: this.salesId }, this.salesId)
      .subscribe(
        (response) => {
          console.log("purchase", response);
          Swal.fire("Sale Updated", "", "success");
          this.isLoader = false;
          this.grandTotal = 0;
          this.subTotal = 0;
          this.orderTax = 0;
